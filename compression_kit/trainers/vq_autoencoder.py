...
class VQAutoencoder(keras.Model):
    ...
    - Accepts extra loss callables (e.g., derivative loss, STFT loss).
    - Accepts extra metrics (keras.metrics.Metric OR callables(y_true, y_pred) -> scalar).
    - Bubbles up VQ metrics ('vq_perplexity', 'vq_usage', 'vq_bits_per_index').
    """
